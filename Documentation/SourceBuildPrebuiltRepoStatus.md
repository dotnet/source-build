...
arcade | 0002-Do-not-build-.NET-Fx-binaries-in-source-build.patch | Prebuilt | Remove | Source-build | Will be unneeded after Aditya's ref assmebly work is done | https://github.com/dotnet/arcade/pull/4047
...
aspnetcore | 0002-Import-PackageVersions.props.patch | Flow | Remove | Source-build | Fixed by Arcade update | 
...
aspnetcore-tooling | 0001-Import-PackageVersions.props.patch | Flow | Remove | Source-build | Fixed by Arcade update | 
...
coreclr | 0001-Allow-separate-tool-and-SDK-directories.patch | Build | Remove | Source-build | Fixed by Arcade update | 
...
roslyn | 0004-Import-PackageVersions-props-if-exists.patch | Flow | Remove | Source-build | Fixed by Arcade update | 
...
websdk | 0001-Add-PVP-import.patch | Flow | Remove | Source-build | Fixed by Arcade update | 
