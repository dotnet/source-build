...
";
        ...
        public static BuildTargetResult PackagePkgProjects(BuildTargetContext c)
        {
            ...
            else
            {
                ...
                string value = Environment.GetEnvironmentVariable("SKIP_RESTORE");
                if(!string.IsNullOrEmpty(value))
                {
                    buildScriptArgList.Add("--skiprestore");
                }

                value = Environment.GetEnvironmentVariable("SKIP_TEST");
                if(!string.IsNullOrEmpty(value))
                {
                    buildScriptArgList.Add("--skiptests");
                }
