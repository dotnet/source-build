...
usage() {
    echo "usage: $0 <path-to-tarball-root> [--skip-build] [--enable-leak-detection] [--skip-prebuilt-check] [--custom-ref-packages <dir>] [--custom-previously-built-packages <dir>] [-- [extra build.sh args]]"
    echo ""
}
...
while :; do
    ...
    case $lowerI in
        ...
        --custom-ref-packages)
            ...
            shift
            ;;
        --custom-previously-built-packages)
