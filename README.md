...
This repo contains a set of scripts for building the .NET Core Runtime and SDK from source. The scripts were built to make it easy for anyone to build the .NET Core product.
...
* .NET Core is composed of several respositories that all need to be built.
