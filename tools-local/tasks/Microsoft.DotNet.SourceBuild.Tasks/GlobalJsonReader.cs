...
// https://raw.githubusercontent.com/NuGet/NuGet.Client/6007570d889b9392fb9826a6d31f99f6acf9e440/src/NuGet.Core/Microsoft.Build.NuGetSdkResolver/GlobalJsonReader.cs
...
namespace Microsoft.DotNet.SourceBuild.Tasks
{
    ...
    internal static class GlobalJsonReader
    {
        ...
        public static Dictionary<string, string> GetMSBuildSdkVersions(SdkResolverContext context)
        {
            ...
            {
                // Failed to parse "{0}". {1}
                var message = string.Format(CultureInfo.CurrentCulture, "Failed to parse \"{0}\". {1}", globalJsonPath, e.Message);
